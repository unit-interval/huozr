<?php
/*
 * 本文件提供了关于连接人人网帐号的相关程序逻辑，
 * OAuth 和 API 访问基于人人网提供的 PHP SDK。
 * 活字网
 */


/*
 * 总体配置，包括API Key, Secret Key，以及所有允许调用的API列表
 */
...
$config->CALLBACK = 'http://'.$_SERVER['SERVER_NAME'].'/login/oauth/renren'; //回调地址

$config->APIURL		= 'http://api.renren.com/restserver.do'; //RenRen网的API调用地址
$config->APIKey		= RENREN_AKEY;	//API Key
$config->SecretKey	= RENREN_SKEY;	//API 密钥
$config->APIVersion	= '1.0';	//当前API的版本号
$config->decodeFormat	= 'json';	//默认的返回格式
/*
