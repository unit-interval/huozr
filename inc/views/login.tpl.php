<div id='login-oauth'> 
	<h4>用合作网站帐号登录</h4> 
	<ul> 
		<li><a href="/login/oauth/sina_weibo" class='button-orange'>新浪微博</a></li>
		<li><a href="/login/oauth/renren" class='button-orange'>人人网</a></li>
		<li><a href="/login/oauth/tencent_weibo" class='button-orange'>腾讯微博</a></li>		
		<li><a href="/login/oauth/douban" class='button-orange'>豆瓣</a></li>			
	</ul> 
</div> 
<div>
	<h4>用活字网账号登录</h4> 
	<form id="form_basic" name="form_basic" action='/login/basic' method='post'>
...
<div>
	<h4>注册活字账号</h4>
	<form id="form_signup" name="form_signup" method="post" action="/login/signup">
		<label>
